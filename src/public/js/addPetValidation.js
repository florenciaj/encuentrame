...
window.addEventListener('DOMContentLoaded', () => {
    ...
    inputs.forEach((input) => {
        ...
        input.addEventListener('input', hasAValue)
    })
    ...
    if (form) {
        form.addEventListener('submit', (e) => {
            ...
            if (validInputs.name && validInputs.breed && validInputs.age && validInputs.gender && validInputs.features && validInputs.place && validInputs.date && validInputs.hour) {
